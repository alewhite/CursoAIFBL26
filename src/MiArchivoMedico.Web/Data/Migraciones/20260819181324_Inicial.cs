        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TituloNormalizado = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Fecha = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    Profesional = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    ProfesionalNormalizado = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Institucion = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    InstitucionNormalizada = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Descripcion = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    DescripcionNormalizada = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoDeContenido = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    TamanoEnBytes = table.Column<long>(type: "INTEGER", nullable: false),
                    Sha256 = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    CargadoEn = table.Column<long>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerId = table.Column<string>(type: "TEXT", nullable: false),
                    EstudioId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Texto = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    TextoNormalizado = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
